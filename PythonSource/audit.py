"""
- audits the OSMFILE and change the variable 'mapping' to reflect the changes needed to fix 
...
- update_city function fixes the street name to correct misspellings and various
    representations (i.e. ending in ', CA')
- finds all the dog related elements
"""
