...
Before processing the data and adding it into MongoDB,
this checks the "k" value for each "<tag>" to see if they can be valid keys in MongoDB,
as well as see if there are any other potential problems.

Uses a handful of regular expressions to check for certain patterns
in the tags. Changes the data model in order to expand
the "addr:street" type of keys to a dictionary like this:
